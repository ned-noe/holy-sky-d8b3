...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/holy-sky-d8b3)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/holy-sky-d8b3
```

A live public deployment of this template is available at [https://holy-sky-d8b3.templates.workers.dev](https://holy-sky-d8b3.templates.workers.dev)
